...
{  
    ...
    int arr[100],st, mid, end, i,tgt;  
    long double  num_range;
    cout << " Define the size of the array: " << endl;  
    cin >> num_range; // get size from user 
    ...
    {  
        ...
        cin >> arr[i];  //getting data to store in a list
    }  
      
    // initialize the starting and ending variable's values  
    st = 0;  
    end = num_range - 1; // size of array (num) - 1  
